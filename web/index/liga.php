        ...
        <div class="row">
          ...
          echo '</select>
                ...
                <div class="col-md-3 col-xs-3 partidoResultadosGoles">
                  <input class="form-control" placeholder="Goles" type="text">
                </div>
                <div class="col-md-12 col-xs-9 transInput">
                  <input class="form-control" placeholder="Visitante" type="text">
                </div>
                <div class="col-md-12 col-xs-9 transInput">
                  <input class="form-control" placeholder="Expulsados" type="text">
                </div>
              </form>
            </div>
            <div class="container col-md-6 col-xs-12 partidoResultados">
              <form class="form-horizontal">
                <div class="col-md-9">
                  <select class="form-control localSelection" id="select">
                    <option>Local</option>';
                    // $db = new Conexion();
                    $consulta2 = $db->query("SELECT nombreeq FROM equipos;");

                    while ($visita = $consulta2->fetch_array(MYSQLI_BOTH)) {
                      echo '<option value='.$visita['nombreeq'].'>'.$visita['nombreeq'].'</option>';
                  }
